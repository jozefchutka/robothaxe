...
import robothaxe.injector.support.injectees.OneRequiredOneOptionalPropertyMethodInjectee;
...
class MethodInjectionPointTest
 {
	...
	public function injectionOfTwoUnnamedPropertiesIntoMethod():Void
	{
		...
		var meta = {inject:null, name:["setDependencies"], args:[{type:"robothaxe.injector.support.types.Class1", opt:false}, {type:"robothaxe.injector.support.types.Interface1", opt:false}]};
	...
	public function injectionOfOneRequiredOneOptionalPropertyIntoMethod():Void
	{
		...
		var meta = {inject:null, name:["setDependencies"], args:[{type:"robothaxe.injector.support.types.Class1", opt:false}, {type:"robothaxe.injector.support.types.Interface1", opt:true}]};
		var injectionPoint = new MethodInjectionPoint(meta);
