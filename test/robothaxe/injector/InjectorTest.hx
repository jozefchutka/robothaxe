...
import robothaxe.injector.support.injectees.InterfaceInjectee;
import robothaxe.injector.support.injectees.NamedClassInjectee;
import robothaxe.injector.support.injectees.NamedInterfaceInjectee;
import robothaxe.injector.support.injectees.StringInjectee;
import robothaxe.injector.support.injectees.RecursiveInterfaceInjectee;
import robothaxe.injector.support.injectees.MultipleSingletonsOfSameClassInjectee;
import robothaxe.injector.support.injectees.ComplexClassInjectee;
import robothaxe.injector.support.injectees.TwoNamedInterfaceFieldsInjectee;
import robothaxe.injector.support.injectees.OneParameterMethodInjectee;
import robothaxe.injector.support.injectees.OneNamedParameterMethodInjectee;
import robothaxe.injector.support.injectees.TwoParametersMethodInjectee;
import robothaxe.injector.support.injectees.TwoNamedParametersMethodInjectee;
import robothaxe.injector.support.injectees.MixedParametersMethodInjectee;
import robothaxe.injector.support.injectees.OneParameterConstructorInjectee;
import robothaxe.injector.support.injectees.TwoParametersConstructorInjectee;
import robothaxe.injector.support.injectees.OneNamedParameterConstructorInjectee;
import robothaxe.injector.support.injectees.TwoNamedParametersConstructorInjectee;
import robothaxe.injector.support.injectees.MixedParametersConstructorInjectee;
import robothaxe.injector.support.injectees.NamedArrayInjectee;
import robothaxe.injector.support.injectees.MultipleNamedSingletonsOfSameClassInjectee;
import robothaxe.injector.support.injectees.XMLInjectee;
import robothaxe.injector.support.injectees.OrderedPostConstructInjectee;
import robothaxe.injector.support.types.Class1;
import robothaxe.injector.support.types.Class2;
import robothaxe.injector.support.types.Interface1;
import robothaxe.injector.support.types.Interface2;
import robothaxe.injector.support.types.ComplexClass;
import robothaxe.injector.support.injectees.SetterInjectee;
